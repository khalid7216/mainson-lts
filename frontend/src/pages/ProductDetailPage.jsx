    ...
    const fetchProduct = async () => {
      try {
        ...
        setProduct({
          ...
          badge: p.badge,
          rating: data.avgRating || Number((4 + Math.random()).toFixed(1)),
          reviews: data.numReviews || Math.floor(Math.random() * 150) + 10,
          image: p.image?.url || p.images?.[0] || p.image || "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500&q=80",
          images: p.images?.length ? p.images : [p.image?.url || "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500&q=80"],
          variants: p.variants || [],
